			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input class="form-control" style="width:380px" type="text" name="homeimg" id="homeimg" value="{rowcontent.homeimgfile}"/>
							<input id="select-img-post" type="button" value="{GLANG.browse_image}" name="selectimg" class="btn btn-info" />
						</td>
					</tr>
					<tr>
